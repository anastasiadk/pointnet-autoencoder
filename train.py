...
parser.add_argument('--data_path', default='data/shapenetcore_partanno_segmentation_benchmark_v0', help='Data path [default: data/shapenetcore_partanno_segmentation_benchmark_v0]')
